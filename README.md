...
- **MiniMax Agent** for [Image Generation](https://www.minimaxi.com/)
    ...
    - Language Generation applications for [speech](https://www.minimax.io/news/minimaxm1) and text [generation](https://www.minimax.io/news/minimax-speech-25)
        - This includes music generation with lyrics or simply choosing genre [MiniMax2.4](https://www.minimax.io/news/music-26)
    ...
    - Test Audio with Poems, written prior (update stx, ignore the random latin ipsum) `./audio/When+the+Ocean+Stops+Kissing+the+Sand.mp3`
